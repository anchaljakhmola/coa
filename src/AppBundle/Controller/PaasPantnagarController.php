...
class PaasPantnagarController extends Controller
{
    /**
     * @Route("/paas-pantnagar/")
     */
    public function paasPantnagarAction(Request $request)
    {
        // replace this example code with whatever you need
        $data = array(
                      'base_dir' => realpath($this->getParameter('kernel.root_dir').'/..'),
                      'title' => "Paas Pantnagar",
                      'paasIntro' => "lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
        ...
        return $this->render('paasPantnagar.html.twig', $data);
    }
}
