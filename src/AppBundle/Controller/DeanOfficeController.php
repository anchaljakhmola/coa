...
class DeanOfficeController extends Controller
{
    /**
     * @Route("deans-office/")
     */
    public function deanOfficeAction()
    {
        ...
        $data = array(
                      ...
                      'deanName' => "Dr. J. kumar",
                      'deanMsg'=>"lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
        ...
        return $this->render('deanOffice.html.twig', $data);
    }
}
